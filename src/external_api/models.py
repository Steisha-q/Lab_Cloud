...
class BookVolumeInfo(BaseModel):
    title: str = Field(..., description="Book title", min_length=cfg.min_title_length, max_length=cfg.max_title_length)
    ...
    publishedDate: Optional[str] = Field(default=None, description="Publication date")
    ...
    pageCount: Optional[int] = Field(default=None, description="Number of pages", ge=0)
    categories: Optional[List[str]] = Field(default=None, description="Book categories")
    imageLinks: Optional[dict] = Field(default=None, description="Book cover images")
    language: Optional[str] = Field(default=None, description="Book language")
    previewLink: Optional[HttpUrl] = Field(default=None, description="Preview link")
    infoLink: Optional[HttpUrl] = Field(default=None, description="Info link")
