...
class GoogleBooksService:
    ...
    async def process_books_data(
        self, query: str = "python programming", max_results: int = 10
        ...
        result = ProcessedBooksResponse(total_books=len(processed_books), books=processed_books)
